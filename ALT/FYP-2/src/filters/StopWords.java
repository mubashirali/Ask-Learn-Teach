...
public class StopWords {
	...
	/*
	 * public static void main(String[] args){ StopWords stopWords = new
	 * StopWords(); removeStopWords("what is chemistry");
	 * 
	 * }
	 */
	public StopWords() {
	...
	public String removeStopWords(String inputQusetion) {
		
		inputQusetion = inputQusetion.toLowerCase().replaceAll("[-+.^:,;\"()'?!]", "");
		String updatedQuery = inputQusetion;
		
		for (String str : inputQusetion.split(" "))
			if (stopWordlst.contains(str))
				updatedQuery = updatedQuery.replaceAll(str, "");

		// System.out.println(updatedQuery);
		return updatedQuery;
	}

	public static ArrayList<String> removeStopWordlist(
			ArrayList<String> sentenceList) {

		int index = 0;
		for (String string : sentenceList) {

			String updatedQuery = string;

			for (String str : string.split(" "))
				str = str.replaceAll("[-+.^:,;\"()'?!]", "");
			if (stopWordlst.contains(string.toLowerCase())) {
				updatedQuery = updatedQuery
						.replaceAll(string.toLowerCase(), "");
				// System.out.println(str);
			}
			sentenceList.set(index, updatedQuery);
